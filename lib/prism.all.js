    ...
    var e = /\blang(?:uage)?-(\w+)\b/i,
      ...
      n = (_self.Prism = {
          ...
          clone: function(e) {
            ...
            switch (t) {
              case 'Object':
                var a = {}
                for (var i in e)
                  e.hasOwnProperty(i) && (a[i] = n.util.clone(e[i]))
                return a
              case 'Array':
                return (
                  e.map &&
        ...
        languages: {
          ...
          DFS: function(e, t, a, i) {
            ...
            for (var r in e)
              e.hasOwnProperty(r) &&
                (t.call(e, r, e[r], a || r),
                'Object' !== n.util.type(e[r]) || i[n.util.objId(e[r])]
                  ? 'Array' !== n.util.type(e[r]) ||
                    i[n.util.objId(e[r])] ||
                    ((i[n.util.objId(e[r])] = !0),
                    n.languages.DFS(e[r], t, r, i))
                  : ((i[n.util.objId(e[r])] = !0),
                    n.languages.DFS(e[r], t, null, i)))
          }
        },
        plugins: {},
        highlightAll: function(e, t) {
          ...
          for (
            var i,
              r = a.elements || document.querySelectorAll(a.selector),
              o = 0;
            (i = r[o++]);

          )
            n.highlightElement(i, e === !0, a.callback)
        },
        highlightElement: function(t, a, i) {
          for (var r, o, s = t; s && !e.test(s.className); ) s = s.parentNode
          s &&
            ((r = (s.className.match(e) || [, ''])[1].toLowerCase()),
            (o = n.languages[r])),
            (t.className =
            ...
            /pre/i.test(s.nodeName) &&
              (s.className =
                ...
                r)
          var l = t.textContent,
            d = { element: t, language: r, grammar: o, code: l }
          if ((n.hooks.run('before-sanity-check', d), !d.code || !d.grammar))
            return (
              d.code && (d.element.textContent = d.code),
              void n.hooks.run('complete', d)
            )
          if ((n.hooks.run('before-highlight', d), a && _self.Worker)) {
            ...
            (d.highlightedCode = n.highlight(d.code, d.grammar, d.language)),
              n.hooks.run('before-insert', d),
              (d.element.innerHTML = d.highlightedCode),
              i && i.call(t),
              n.hooks.run('after-highlight', d),
        ...
        highlight: function(e, t, i) {
          ...
          return a.stringify(n.util.encode(r), i)
        },
                ...
                for (var f = 0, h = 0; f < i.length; h += i[f].length, ++f) {
                  ...
                  if (!(S instanceof a)) {
                    ...
                    var E = d.exec(S),
                      y = 1
                    if (!E && u && f != i.length - 1) {
                      if (((d.lastIndex = h), (E = d.exec(e)), !E)) break
                      for (
                        var v = E.index + (p ? E[1].length : 0),
                        ...
                        (T += i[k].length), v >= T && (++f, (h = T))
                      if (i[f] instanceof a || i[k - 1].greedy) continue
                      ;(y = k - f), (S = e.slice(h, T)), (E.index -= h)
                    }
                    if (E) {
                      p && (m = E[1].length)
                      var v = E.index + m,
                        ...
                        I = [f, y]
                      _ && I.push(_)
                      var P = new a(o, c ? n.tokenize(E, c) : E, g, E, u)
                      I.push(P),
                        C && I.push(C),
                        Array.prototype.splice.apply(i, I)
                    }
                  }
                }
              }
        ...
        hooks: {
          ...
          run: function(e, t) {
            var a = n.hooks.all[e]
            if (a && a.length) for (var i, r = 0; (i = a[r++]); ) i(t)
          }
        }
      }),
    ...
    for (
      ...
      ;(o = 'string' == typeof o ? { filter: o, language: o } : o),
        e.languages[o.language] &&
          (a['filter-' + o.filter] = {
            pattern: RegExp(t.replace('{{filter_name}}', o.filter)),
            lookbehind: !0,
            inside: {
    ...
    ;(e.languages.handlebars = e.languages.extend('markup', {
      ...
      e.hooks.add('after-highlight', function(t) {
        if ('handlebars' === t.language) {
          for (var n, a = 0; (n = t.tokenStack[a]); a++)
            t.highlightedCode = t.highlightedCode.replace(
              '___HANDLEBARS' + (a + 1) + '___',
              e.highlight(n, t.grammar, 'handlebars').replace(/\$/g, '$$$$')
            )
...
;(Prism.languages.icon = {
  ...
  (Prism.languages.livescript = {
    ...
    comment: [
      { pattern: /(^|[^\\])\/\*[\w\W]*?\*\//, lookbehind: !0, greedy: !0 },
  ...
  (Prism.languages.powershell.string[0].inside[
    'function'
  ].inside = Prism.util.clone(Prism.languages.powershell)),
    ...
    t.forEach(function(t) {
      ...
      if (
        ...
        ;(i['inline-lang-' + a] = {
          ...
          (i['inline-lang-' + a].inside.rest = e.util.clone(e.languages[a])),
  ...
  !(function(e) {
    ...
    ;(e.languages.jsx = e.languages.extend('markup', t)),
      (e.languages.jsx.tag.pattern = /<\/?[\w\.:-]+\s*(?:\s+[\w\.:-]+(?:=(?:("|')(\\?[\w\W])*?\1|[^\s'">=]+|(\{[\w\W]*?\})))?\s*)*\/?>/i),
      ...
      e.hooks.add('after-highlight', function(t) {
        if ('smarty' === t.language) {
          for (var n, a = 0; (n = t.tokenStack[a]); a++)
            t.highlightedCode = t.highlightedCode.replace(
              '___SMARTY' + (a + 1) + '___',
              e.highlight(n, t.grammar, 'smarty').replace(/\$/g, '$$$$')
            )
          t.element.innerHTML = t.highlightedCode
        }
      })
  ...
  !(function(e) {
    ...
    ;(e.languages.textile.tag.pattern = /<\/?(?!\d)[a-z0-9]+(?:\s+[^\s>\/=]+(?:=(?:("|')(?:\\\1|\\?(?!\1)[\w\W])*\1|[^\s'">=]+))?)*\s*\/?>/i),
      ...
      (e.languages.textile.phrase.inside.table.inside.footnote = a.footnote),
      (e.languages.textile.phrase.inside.table.inside.acronym = a.acronym),
