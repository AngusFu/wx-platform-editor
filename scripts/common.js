...
const Loading = (function() {
  var html =
    '<style>.load3{height:60px;margin:100px auto;position:relative;width:60px}\
...
const store = {
  ...
  get(key) {
    return (
      (this.has(key) && JSON.parse(this.db.getItem(this.prefix + key))) || null
    )
  },
